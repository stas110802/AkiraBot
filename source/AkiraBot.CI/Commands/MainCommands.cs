...
public sealed class MainCommands : VoidCommandsObject
{
   private TakeProfitStopLossBot? _bot;
    ...
    public void CreateClientCommand()
    {
        ...
        var client = _clientCommands.ReadFuncCommandKey();// _clientCommands.ReadFuncCommandKey<IExchangeClient>();
        if (client != null)
            _client = client;
    ...
    public void PrintAccountBalanceCommand()
    {
        ...
        Console.WriteLine("BTC = 0.0001");
        Console.WriteLine("USDT = 12.24");
